...
void GraphicsWindows::Init(int width, int height)
{
	bool succes;
	succes = glfwInit();
	assert(succes);
...
#ifdef FULLSCREEN
	mWindow = glfwCreateWindow(width, height, windowTitle.c_str(), glfwGetPrimaryMonitor(), 0);
#else
	...
	{
		LOGWARNING("I still get this error: " << dummy);
	}
